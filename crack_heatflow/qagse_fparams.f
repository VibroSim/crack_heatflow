c     This software in public domain because it was part of SLATEC
      subroutine qagse(f,fp1,fp2,fp3,fp4,fp5,fp6,fp7,fp8,
...
c            fp3    - real  parameter #3 for f
c            fp4    - real  parameter #4 for f
c            fp5    - real  parameter #5 for f
c            fp6    - real  parameter #6 for f
...
c
      ...
      oflow = r1mach(2)
      ierro = 0
      call qk21(f,fp1,fp2,fp3,fp4,fp5,fp6,fp7,fp8, 
...
c
  ...
  100 abserr = amax1(abserr,0.5e+01*epmach*abs(result))
      ...
      subroutine qk21(f,fp1,fp2,fp3,fp4,fp5,fp6,fp7,fp8,
...
c
      resg = 0.0e+00
      fc = funct(centr,fp1,fp2,fp3,fp4,fp5,fp6,fp7,fp8)
      resk = wgk(11)*fc
      resabs = abs(resk)
      do 10 j=1,5
        jtw = 2*j
        absc = hlgth*xgk(jtw)
        fval1 = funct(centr-absc,fp1,fp2,fp3,fp4,fp5,fp6,fp7,fp8)
        fval2 = funct(centr+absc,fp1,fp2,fp3,fp4,fp5,fp6,fp7,fp8)
        fv1(jtw) = fval1
        fv2(jtw) = fval2
        fsum = fval1+fval2
        resg = resg+wg(j)*fsum
